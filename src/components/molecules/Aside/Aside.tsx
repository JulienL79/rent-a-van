        ...
        return (
            <aside className="sidebar">
                ...
                <nav className="profile-nav">
                    ...
                    {page === 'admin' && (
                        <ul>
                            <li><NavItem to="/admin/home" content="Accueil" className={active === 'home' ? 'active' : ''} /></li>
                            ...
                            <li><NavItem to="/admin/messages" content="Messages" className={active === 'messages' ? 'active' : ''} /></li>
                        </ul>
                    )}

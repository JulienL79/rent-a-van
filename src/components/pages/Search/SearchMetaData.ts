...
export const searchMetaDatas: ISearchMetaData[] = [
  ...
  {
    page: 'vehicle',
    titlePage: 'Détail du véhicule',
    title: 'RentAVan - Fiche véhicule',
    description: 'Consultez les informations détaillées du véhicule sélectionné, ses caractéristiques, tarifs et disponibilités.'
  }
];

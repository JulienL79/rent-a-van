        ...
        <div className="page">
            ...
            <section className="content">
                ...
                <article className="paragraph">
                    <p>Chez RentAVan, nous accordons une grande importance à la protection de vos données personnelles. Cette politique de confidentialité explique comment nous collectons, utilisons et protégeons vos informations lorsque vous utilisez notre site web et nos services.</p>
                </article>
                ...
                <article className="paragraph">
                    ...
                    <p>Nous mettons en place des mesures de sécurité techniques et organisationnelles pour protéger vos données personnelles contre tout accès non autorisé, perte ou altération.</p>
                </article>

                <article className="paragraph">
                    <h2>5. Partage des données</h2>
                    <p>Nous ne vendons jamais vos données personnelles à des tiers. Nous pouvons partager vos informations avec :</p>
                    <ul>
                ...
                <article className="paragraph">
                    <h2>7. Cookies</h2>
                    <p>Nous utilisons des cookies pour améliorer votre expérience sur notre site. Vous pouvez gérer vos préférences en matière de cookies via les paramètres de votre navigateur.</p>
                </article>
                ...
                <article className="paragraph">
                    ...
                    <p>Si vous avez des questions concernant cette politique de confidentialité ou l'utilisation de vos données personnelles, veuillez nous contacter à l'adresse suivante : <a href="mailto:privacy@rentavan.com" target="_blank" className="text-link">privacy@rentavan.com</a></p>
                </article>
